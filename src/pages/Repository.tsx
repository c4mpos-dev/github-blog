    ...
    return (
        <div className="flex items-center flex-col">
            <div className="flex justify-center items-center">
                <div className="absolute w-[54rem] p-6 bg-base-profile rounded-lg shadow-lg shadow-black/50">
                    ...
                    <h1 className="text-2xl font-bold text-base-title">{repo.name || userData?.login}</h1>
            ...
            <div className="flex flex-col w-[54rem] px-6 py-5 bg-base-post mt-32 rounded-lg">
                ...
                <div className="flex items-center mt-4 gap-4">
                    <span className="flex items-center gap-2">
                        ...
                        Created {formatDistanceToNow(repo.created_at, { addSuffix: true })}
                    </span>
                    ...
                    <span className="flex items-center gap-2">
                        ...
                        Updated {formatDistanceToNow(repo.updated_at, { addSuffix: true })}
                    </span>
                </div>
            </div>
        </div>
